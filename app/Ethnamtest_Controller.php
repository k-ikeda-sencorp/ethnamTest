...
require_once 'Ethnamtest_Error.php';
require_once 'Ethnamtest_ActionClass.php';
require_once 'Ethnamtest_ActionForm.php';
require_once 'Ethnamtest_ViewClass.php';
require_once 'Ethnamtest_UrlHandler.php';

/**
 *  Ethnamtest application Controller definition.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Ethnamtest
 */
class Ethnamtest_Controller extends Ethna_Controller
{
    /**#@+
     *  @access protected
     */
    ...
    protected $forward = array(
         ...
         *
         *  'index'         => array(
         *      'view_name' => 'Ethnamtest_View_Index',
         *  ),
         */
    );
    ...
    public $class = array(
        ...
        'form'          => 'Ethnamtest_ActionForm',
        'i18n'          => 'Ethna_I18N',
        'logger'        => 'Ethna_Logger',
        'plugin'        => 'Ethna_Plugin',
        'session'       => 'Ethna_Session',
        'view'          => 'Ethnamtest_ViewClass',
        'renderer'      => 'Ethna_Renderer_Smarty',
        'url_handler'   => 'Ethnamtest_UrlHandler',
    );
